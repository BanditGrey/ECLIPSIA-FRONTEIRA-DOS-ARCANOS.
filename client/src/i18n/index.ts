...
export const translations: Record<LangCode, TranslationTree> = {
  "pt-BR": {
    ...
    "combos": {
      ...
      "sword_one_glyph": { "name": "Fundido" },
      "sword_two_glyph": { "name": "Fundido" },
      "great_sword_glyph": { "name": "Fundido" },
      "dagger_glyph": { "name": "Fundido" },
      "dagger_off_glyph": { "name": "Fundido" },
      "bow_short_glyph": { "name": "Fundido" },
      "bow_long_glyph": { "name": "Fundido" },
      "staff_one_glyph": { "name": "Fundido" },
      "staff_two_glyph": { "name": "Fundido" },
      "orb_glyph": { "name": "Fundido" },
      "tome_glyph": { "name": "Fundido" },
      "hammer_glyph": { "name": "Fundido" },
      "spear_glyph": { "name": "Fundido" },
      "shield_glyph": { "name": "Fundido" },
      "glyph_sword_one": { "name": "Glifomante" },
      "glyph_sword_two": { "name": "Glifomante" },
      "glyph_great_sword": { "name": "Glifomante" },
      "glyph_dagger": { "name": "Glifomante" },
      "glyph_dagger_off": { "name": "Glifomante" },
      "glyph_bow_short": { "name": "Glifomante" },
      "glyph_bow_long": { "name": "Glifomante" },
      "glyph_staff_one": { "name": "Glifomante" },
      "glyph_staff_two": { "name": "Glifomante" },
      "glyph_orb": { "name": "Glifomante" },
      "glyph_tome": { "name": "Glifomante" },
      "glyph_hammer": { "name": "Glifomante" },
      "glyph_spear": { "name": "Glifomante" },
      "glyph_shield": { "name": "Glifomante" },
      "glyph_glyph": { "name": "Sigilos Gêmeos" }
    },    "login": {
    ...
    "combat": {
      ...
      "fusionActive": "Fusão elemental: {fusion}! Aura da arma despertada (+10% dano).",
      "attack": "Atacar",
      "defend": "Defender",
      "skills": "Habilidades",
      "flee": "Fugir",
  ...
  "en-US": {
    ...
    "combos": {
      ...
      "sword_one_glyph": { "name": "Spellfused" },
      "sword_two_glyph": { "name": "Spellfused" },
      "great_sword_glyph": { "name": "Spellfused" },
      "dagger_glyph": { "name": "Spellfused" },
      "dagger_off_glyph": { "name": "Spellfused" },
      "bow_short_glyph": { "name": "Spellfused" },
      "bow_long_glyph": { "name": "Spellfused" },
      "staff_one_glyph": { "name": "Spellfused" },
      "staff_two_glyph": { "name": "Spellfused" },
      "orb_glyph": { "name": "Spellfused" },
      "tome_glyph": { "name": "Spellfused" },
      "hammer_glyph": { "name": "Spellfused" },
      "spear_glyph": { "name": "Spellfused" },
      "shield_glyph": { "name": "Spellfused" },
      "glyph_sword_one": { "name": "Glyphbinder" },
      "glyph_sword_two": { "name": "Glyphbinder" },
      "glyph_great_sword": { "name": "Glyphbinder" },
      "glyph_dagger": { "name": "Glyphbinder" },
      "glyph_dagger_off": { "name": "Glyphbinder" },
      "glyph_bow_short": { "name": "Glyphbinder" },
      "glyph_bow_long": { "name": "Glyphbinder" },
      "glyph_staff_one": { "name": "Glyphbinder" },
      "glyph_staff_two": { "name": "Glyphbinder" },
      "glyph_orb": { "name": "Glyphbinder" },
      "glyph_tome": { "name": "Glyphbinder" },
      "glyph_hammer": { "name": "Glyphbinder" },
      "glyph_spear": { "name": "Glyphbinder" },
      "glyph_shield": { "name": "Glyphbinder" },
      "glyph_glyph": { "name": "Twin Sigil" }
    },    "login": {
    ...
    "combat": {
      ...
      "fusionActive": "Elemental fusion: {fusion}! Weapon aura awakened (+10% damage).",
      "attack": "Attack",
      "defend": "Defend",
      "skills": "Skills",
      "flee": "Flee",
  ...
  "es-ES": {
    ...
    "combos": {
      ...
      "sword_one_glyph": { "name": "Fusionado" },
      "sword_two_glyph": { "name": "Fusionado" },
      "great_sword_glyph": { "name": "Fusionado" },
      "dagger_glyph": { "name": "Fusionado" },
      "dagger_off_glyph": { "name": "Fusionado" },
      "bow_short_glyph": { "name": "Fusionado" },
      "bow_long_glyph": { "name": "Fusionado" },
      "staff_one_glyph": { "name": "Fusionado" },
      "staff_two_glyph": { "name": "Fusionado" },
      "orb_glyph": { "name": "Fusionado" },
      "tome_glyph": { "name": "Fusionado" },
      "hammer_glyph": { "name": "Fusionado" },
      "spear_glyph": { "name": "Fusionado" },
      "shield_glyph": { "name": "Fusionado" },
      "glyph_sword_one": { "name": "Glifomante" },
      "glyph_sword_two": { "name": "Glifomante" },
      "glyph_great_sword": { "name": "Glifomante" },
      "glyph_dagger": { "name": "Glifomante" },
      ...
      "glyph_spear": { "name": "Glifomante" },
      "glyph_shield": { "name": "Glifomante" },
      "glyph_glyph": { "name": "Sigilos Gemelos" }
    },    "login": {
    ...
    "combat": {
      ...
      "fusionActive": "Fusión elemental: ¡{fusion}! Aura del arma despertada (+10% daño).",
      "attack": "Atacar",
      "defend": "Defender",
      "skills": "Habilidades",
      "flee": "Huir",
  ...
  "ja-JP": {
    ...
    "combos": {
      ...
      "sword_one_glyph": { "name": "錬成" },
      "sword_two_glyph": { "name": "錬成" },
      "great_sword_glyph": { "name": "錬成" },
      "dagger_glyph": { "name": "錬成" },
      "dagger_off_glyph": { "name": "錬成" },
      "bow_short_glyph": { "name": "錬成" },
      "bow_long_glyph": { "name": "錬成" },
      "staff_one_glyph": { "name": "錬成" },
      "staff_two_glyph": { "name": "錬成" },
      "orb_glyph": { "name": "錬成" },
      "tome_glyph": { "name": "錬成" },
      "hammer_glyph": { "name": "錬成" },
      "spear_glyph": { "name": "錬成" },
      "shield_glyph": { "name": "錬成" },
      "glyph_sword_one": { "name": "グリフ使い" },
      "glyph_sword_two": { "name": "グリフ使い" },
      "glyph_great_sword": { "name": "グリフ使い" },
      "glyph_dagger": { "name": "グリフ使い" },
      "glyph_dagger_off": { "name": "グリフ使い" },
      "glyph_bow_short": { "name": "グリフ使い" },
      "glyph_bow_long": { "name": "グリフ使い" },
      "glyph_staff_one": { "name": "グリフ使い" },
      "glyph_staff_two": { "name": "グリフ使い" },
      "glyph_orb": { "name": "グリフ使い" },
      "glyph_tome": { "name": "グリフ使い" },
      "glyph_hammer": { "name": "グリフ使い" },
      "glyph_spear": { "name": "グリフ使い" },
      "glyph_shield": { "name": "グリフ使い" },
      "glyph_glyph": { "name": "双紋" }
    },    "login": {
      "title": "エクリプシアにログイン",
    ...
    "combat": {
      ...
      "fusionActive": "属性融合：{fusion}！武器のオーラが覚醒（ダメージ+10%）。",
      "attack": "攻撃",
      "defend": "防御",
      "skills": "スキル",
      "flee": "逃走",
